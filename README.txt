...
Assignments for CS116: Introduction to Security at Tufts in 2023 Fall.
In this lab, Scapy is used to detect several types of scans and potential crisis.
<!-- This file is renderable in md format -->
...
- [x] Identify what aspects of the work have been correctly implemented and what have not.
  ...
  - For Nikto scan, I found the keyword `Nikto` in HTTP GET requests through wireshark, so I checked only the user-agent payload and alerted correctly for `nikto.pcap`.
